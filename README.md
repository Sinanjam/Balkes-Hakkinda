...
- Birleşik deponun veri manifestini öncelikli kullanma; veri henüz yayımlanmamışsa
  eski skor deposuna otomatik ve görünmez geri dönüş.
...
`SCORE_BASE_URL`, `SCORE_MIRROR_BASE_URL`, `SCORE_FALLBACK_BASE_URL`, `ARCHIVE_MANIFEST_URL` ve
